...
// export async function minBalanceFromIndividTrans(
//   req: Request,
//   res: Response,
//   next: NextFunction
// ) {
...
//       JSON.parse(JSON.stringify(config.account_minimum_transfer)),
//       300
//     );
//     next();
//   } catch (err) {
...
// export async function createFamilyBaseMiddle(
//   req: Request,
//   res: Response,
//   next: NextFunction
// ) {
...
//     // Validator.mandatoryFieldExists(family,['oweners','currency']);
...
// export async function createFamilyOwnerseMiddle(
//   req: Request,
//   res: Response,
//   next: NextFunction
// ) {
